...
#include "ethercat_generic_plugins/common_defs.hpp"
...
class ECMutilAxisDrive : public GenericEcSlave
{
public:
  ECMutilAxisDrive();
  virtual ~ECMutilAxisDrive();
...
protected:
  ...
  DeviceState last_state_{DeviceState::STATE_START};
  DeviceState state_{DeviceState::STATE_START};
  ...
  int axis_index_real_;
  std::vector<ec_pdo_entry_info_t> need_to_register_domains_channels_;
